  ...
  let fun_decls =
    List.map
      ...
      (Set_of_closures.function_decls sc
       |> Function_declarations.funs_in_order |> Function_slot.Lmap.map (fun ({ code_id; _ } : Function_declarations.code_id_in_function_declaration) -> code_id) |> Function_slot.Lmap.bindings)
  in
