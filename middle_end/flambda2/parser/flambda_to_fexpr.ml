  ...
  let fun_decls =
    List.map
      ...
      (Set_of_closures.function_decls sc
       |> Function_declarations.funs_in_order |> Function_slot.Lmap.map (function Function_declarations.Deleted -> Misc.fatal_error "todo" | Function_declarations.Code_id code_id -> code_id) |> Function_slot.Lmap.bindings)
  in
